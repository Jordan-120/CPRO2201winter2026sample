...
#Modify the program such that instead of calculating the invoice total for one customer, 
# the program asks the user whether to repeat executing the program or not. Something like:


#    Do you want to repeat the program: y/n

#If the user enters “y”, you ask for customer type (r or w), and calculate the invoice total. 
# Stop the program when the user enters “n” in response to the prompt above.